                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select id="study_id" name="study_id" class="form-control">
                                ...
                                <option value="1" @if($user->study_id == 1) selected @endif>Informacijski i poslovni
                                    sustavi
                                </option>
                                <option value="2" @if($user->study_id == 2) selected @endif>Ekonomika poduzetništva
                                </option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <label class="checkbox-inline" for="visible-0">
                                <input type="checkbox" name="visible" id="visible-0" value="1"
                                       @if($mentor->visible) checked @endif>
